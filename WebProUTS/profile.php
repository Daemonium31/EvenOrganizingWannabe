...
<body>
    <div class="containerlist">
        <h1>Profile Navigation</h1>
        <div class="sidebar">
            <table class="sidebar-table">
                <tr>
                    <td><a href="/EventOrganizingWannabe/WebProUTS/profile.php">Profile</a></td>
                </tr>
                <tr>
                    <td><a href="/EventOrganizingWannabe/WebProUTS/user_dashboard.php">Dashboard</a></td>
                </tr>
                <tr>
                    <td><a href="/EventOrganizingWannabe/WebProUTS/view_registrations.php">Registration Management</a></td>
                </tr>
                <tr>
                    <td><a href="/EventOrganizingWannabe/WebProUTS/logout.php">Logout</a></td>
                </tr>
            </table>
        </div>
    </div>
